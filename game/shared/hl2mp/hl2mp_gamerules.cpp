...
/////
	...
	// SO2 - James
	// Changed view height and gravity to more closely match player models
...
static HL2MPViewVectors g_HL2MPViewVectors(
	...
	Vector( -16, -16, 0 ),	  //VEC_DUCK_HULL_MIN (m_vDuckHullMin)
	Vector( 16, 16, 49 ),	  //VEC_DUCK_HULL_MAX	(m_vDuckHullMax)
	Vector( 0, 0, 42 ),		  //VEC_DUCK_VIEW		(m_vDuckView)
							  					
	Vector(-10, -10, -10 ),	  //VEC_OBS_HULL_MIN	(m_vObsHullMin)
	Vector( 10, 10, 10 ),	  //VEC_OBS_HULL_MAX	(m_vObsHullMax)
							  					
	Vector( 0, 0, 23 ),		  //VEC_DEAD_VIEWHEIGHT (m_vDeadViewHeight)

	Vector( -16, -16, 0 ),	  //VEC_CROUCH_TRACE_MIN (m_vCrouchTraceMin)
	Vector( 16, 16, 49 )	  //VEC_CROUCH_TRACE_MAX (m_vCrouchTraceMax)
);
...
/////
	...
	// SO2 - James
	// Disable teamplay (at least for now)
