...
DECLARE_HUDELEMENT( CHudSOStamina );
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CHudSOStamina::CHudSOStamina( const char *pElementName ) : CHudElement( pElementName ), BaseClass( NULL, "HudSOStamina" )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CHudSOStamina::OnThink( void )
{
...
void CHudSOStamina::Paint()
{
	...
	wchar_t *tempString = g_pVGuiLocalize->Find("#SO_HUD_AUX_POWER");
