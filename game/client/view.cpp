...
//////
	...
	// SO2 - James
	// Change default view model FOV for CS:S weapons
...
// 65 actually looks more natural in regards to CS:S weapons, so we'll use it instead of the default 54
...
//////
	...
	// SO2 - James
	// Stop the rotation of view models while using suit zoom
	// http://developer.valvesoftware.com/wiki/HL2_snippets#Stopping_viewmodels_from_getting_rotated_when_zooming
