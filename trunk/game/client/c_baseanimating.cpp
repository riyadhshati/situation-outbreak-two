...
/////
	...
	// SO2 - James
	// Slowly fade out ragdolls after a short period of time

	m_flFadeOutWaitTime = gpGlobals->curtime + 3.0f;	// fade out will begin in approximately 3 seconds (this can be changed here)
...
/////
	...
	if ( gpGlobals->curtime >= m_flFadeOutWaitTime )
		SUB_Remove();
