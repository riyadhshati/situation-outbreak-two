...
//-----------------------------------------------------------------------------
class CHudSOStamina : public CHudElement, public vgui::Panel
{
	DECLARE_CLASS_SIMPLE( CHudSOStamina, vgui::Panel );

public:
	CHudSOStamina( const char *pElementName );
...
private:
	CPanelAnimationVar( Color, m_AuxPowerColor, "AuxPowerColor", "225 225 225 200" );
